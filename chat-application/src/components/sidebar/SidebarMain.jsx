...
const SidebarMain = () => {
    ...
    return (
        <div className="min-h-screen min-w-[400px] w-[400px] bg-gradient-to-b from-slate-900 to-slate-800 p-4 text-white flex flex-col gap-4 border-r border-slate-700 relative">
